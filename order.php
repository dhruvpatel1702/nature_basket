...
$keyId = "rzp_test_XJEyStQjYGbyFu";
$keySecret = "5TSbonWkQbyMPI3ZItnLfAsP";

$api = new Api($keyId, $keySecret);

$amount = (int) $_POST['order_price']; // Example amount in paise (₹500.00)
$orderData = [
    'receipt' => 'NB_ORDER_' . time(),
    'amount' => $amount * 100,
    'currency' => 'INR',
    'payment_capture' => 1
];
...
try {
    ...
    $transaction_id = $order['id'];  // Assuming this is the payment gateway's order ID
        ...
        if (!empty($_SESSION['cart'])) {
            ...
            foreach ($_SESSION['cart'] as $cart_item) {
                ...
                $insert_order = "INSERT INTO orders (order_type, user_id, transaction_id, billing_id, product_id,product_price, quantity, total_amount) 
                                 VALUES ('2', '$user_id', '$transaction_id', '$billing_id', '$product_id', '$product_price','$quantity', '$amount')";
